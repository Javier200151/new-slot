...
<div class="community-shell">
    <span class="community-kicker">Área 51</span>
    <h1 class="community-title">Votaciones</h1>
    <p class="community-lead">
        Decisiones abiertas a los miembros de Squad Alpha. Cada votación puede tener reglas distintas de selección, privacidad y resultados.
    </p>

    @if(session('status') === 'vote-saved')
        <div class="community-flash">Tu voto se ha guardado.</div>
    @elseif(session('status') === 'poll-closed')
        <div class="community-notice">Esta votación ya no está abierta. Puedes consultar la información disponible aquí.</div>
    @elseif(session('status') === 'vote-locked')
        <div class="community-notice">Tu voto ya está registrado y esta votación no permite modificarlo.</div>
    @endif
