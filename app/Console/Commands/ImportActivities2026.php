...
class ImportActivities2026 extends Command
{
    protected $signature = 'activities:import-2026
    ...
    protected $description =
        'Importa los actividades de 2026 desde el JSON del foro antiguo';

    public function handle(): int
    {
        $activitysPath = $this->resolvePath(
        ...
        */
        ...
        if (! is_file($activitysPath)) {
            $this->error(
                "No se encontró el JSON de actividades: {$activitysPath}"
            );
        ...
        */
        ...
        if (
            ...
            $this->error(
                'El JSON de actividades no contiene un array "misiones" válido.'
            );
        ...
        */
        ...
        /*
        |--------------------------------------------------------------------------
        | Estado de los actividades importados
        |--------------------------------------------------------------------------
        |
        | MUY IMPORTANTE:
        |
